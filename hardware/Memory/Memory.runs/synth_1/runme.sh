...
HD_PWD='C:/Users/alope/OneDrive/ECE_524/sp23-e524-lab4-mem-alopez099/hardware/Memory/Memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sync_rom.tcl

...
HD_PWD='C:/Users/alope/Documents/ECE_524/sp23-e524-lab4-mem-alopez099/hardware/fpga_memory/fpga_memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sign_magnitude_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sign_magnitude_adder.tcl

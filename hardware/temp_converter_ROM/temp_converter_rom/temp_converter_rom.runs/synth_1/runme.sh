...
HD_PWD='C:/Users/alope/OneDrive/ECE_524/sp23-e524-lab4-mem-alopez099/hardware/temp_converter_ROM/temp_converter_rom/temp_converter_rom.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log temp_coverter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temp_coverter.tcl
